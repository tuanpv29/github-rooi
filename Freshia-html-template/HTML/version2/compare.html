      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-6 col-md-4 col-sm-4 col-xs-12 logo-block"> 
            <!-- Header Logo -->
            <div class="logo"> <a title="Magento Commerce" href="index.html"><img alt="Freshia" src="images/logo1.png"> </a> </div>
            <!-- End Header Logo --> 
          </div>
            ...
            <table class=" data-table compare-table">
              ...
              <tbody>
                <tr class="product-shop-row first odd">
                  <th>&nbsp;</th>
                  <td><a href="#" class="btn btn-cancel" title="Remove This Item"><i class="fa fa-remove"></i></a> <a class="product-image" href="#" title="Azrouel Dress"><img src="products-images/product1.jpg" alt="Azrouel Dress" width="200"></a>
                  ...
                  <td><a href="#" class="btn btn-cancel" title="Remove This Item"><i class="fa fa-remove"></i></a><a class="product-image" href="#" title="Blue Lagoon polka-dot chiffon and lace thong"><img src="products-images/product2.jpg" alt="Azrouel Dress" width="200"></a>
